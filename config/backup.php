    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // The code is in git; what's irreplaceable is the database (dumped
                    // separately below) and uploaded files. Keep the archive lean.
                    storage_path('app'),
                ],
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. Always keep a
             * local copy; add an off-site S3-compatible disk (Backblaze B2 /
             * Cloudflare R2 / Wasabi / S3) by setting BACKUP_OFFSITE_DISK=s3.
             */
